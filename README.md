...
This playbook requires Ansible 2.7 or higher.
...
- `gitlab_runner_skip_package_repo_install`- Skip the APT or YUM repository installation (by default, false). You should provide a repository containing the needed packages before running this playbook.
...
For each gitlab runner in gitlab_runner_runners you can set cache options. At the moment playbook support s3, azure and gcs types.
